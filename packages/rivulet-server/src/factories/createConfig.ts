...
export default async (): Promise<Config> => {
    ...
    if (!config.secretKey) {
        ...
        warn(chalk`Autogenerated a file with randomized keys and salts for you. {bold If you wish to harden your security, please update the file configuration file at {cyan ${configPath}} yourself!}`);
